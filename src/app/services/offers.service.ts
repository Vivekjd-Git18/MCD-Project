...
getAllOffers(){
  return this.http.get<any>(this.URL +'/Offers')
  .pipe(map((res:any)=>{
    return res
  }))
}
...
deleteOffers(id:number){
  return this.http.delete<any>(this.URL +'/Offers/'+id)
  .pipe(map((res:any)=>{
    return res
  }))
...
postOffers(data:any){
  return this.http.post<any>(this.URL +'/Offers',data)
  .pipe(map((res:any)=>{
    return res
  }))
}

updateOffers(data:any,id:number){
  return this.http.put<any>(this.URL +'/Offers /'+id,data)
  .pipe(map((res:any)=>{
    return res;
  }))
}
